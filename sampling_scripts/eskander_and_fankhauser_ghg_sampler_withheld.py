...
with pm.Model() as model:
    ...
    ghg_posterior = pm.Normal("ghg_posterior", ghg_prior, ghg_std, observed=y_train)
...
with model:
    ...
    y_pred = pm.Normal("y_pred", mu=mu_pred, sigma=ghg_std)
...
with open('models/eskander_and_fankhauser_prediction_intervals_ghg.pkl', 'wb') as buff:
